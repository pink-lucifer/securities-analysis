...
func InsertListedSymbol(tx *sqlx.Tx, symbol *TblListedSymbol) (int64, int64, error) {
...
func SelectListedSymbolByMktAndSym(db *sqlx.DB, mkt uint16, symbol string) ([]TblListedSymbol, error) {
